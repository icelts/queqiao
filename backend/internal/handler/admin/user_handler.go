...
func validateCommissionRateInput(rate *float64) bool {
...
type CreateUserRequest struct {
	...
	CustomFirstCommissionRate     *float64 `json:"custom_first_commission_rate"`
	CustomRecurringCommissionRate *float64 `json:"custom_recurring_commission_rate"`
...
func (h *UserHandler) Create(c *gin.Context) {
	...
	if !validateCommissionRateInput(req.CustomFirstCommissionRate) || !validateCommissionRateInput(req.CustomRecurringCommissionRate) {
	...
	user, err := h.adminService.CreateUser(c.Request.Context(), &service.CreateUserInput{
		...
		CustomFirstCommissionRate:     req.CustomFirstCommissionRate,
		CustomRecurringCommissionRate: req.CustomRecurringCommissionRate,
